...
#include "wkw.buffempt_tilde.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<wkw_buffempt_tilde> an_instance;
        wkw_buffempt_tilde&              my_object = an_instance;
